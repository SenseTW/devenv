...
ALTER TABLE ONLY public.user_group DROP CONSTRAINT fk__user_group__user_id__user;
ALTER TABLE ONLY public.user_group DROP CONSTRAINT fk__user_group__group_id__group;
ALTER TABLE ONLY public."user" DROP CONSTRAINT fk__user__activation_id__activation;
ALTER TABLE ONLY public.token DROP CONSTRAINT fk__token__authclient_id__authclient;
ALTER TABLE ONLY public."group" DROP CONSTRAINT fk__group__creator_id__user;
ALTER TABLE ONLY public.flag DROP CONSTRAINT fk__flag__user_id__user;
ALTER TABLE ONLY public.flag DROP CONSTRAINT fk__flag__annotation_id__annotation;
ALTER TABLE ONLY public.featurecohort_user DROP CONSTRAINT fk__featurecohort_user__user_id__user;
ALTER TABLE ONLY public.featurecohort_user DROP CONSTRAINT fk__featurecohort_user__cohort_id__featurecohort;
ALTER TABLE ONLY public.featurecohort_feature DROP CONSTRAINT fk__featurecohort_feature__feature_id__feature;
ALTER TABLE ONLY public.featurecohort_feature DROP CONSTRAINT fk__featurecohort_feature__cohort_id__featurecohort;
ALTER TABLE ONLY public.document_uri DROP CONSTRAINT fk__document_uri__document_id__document;
ALTER TABLE ONLY public.document_meta DROP CONSTRAINT fk__document_meta__document_id__document;
ALTER TABLE ONLY public.authzcode DROP CONSTRAINT fk__authzcode__user_id__user;
ALTER TABLE ONLY public.authzcode DROP CONSTRAINT fk__authzcode__authclient_id__authclient;
ALTER TABLE ONLY public.authticket DROP CONSTRAINT fk__authticket__user_id__user;
ALTER TABLE ONLY public.annotation_moderation DROP CONSTRAINT fk__annotation_moderation__annotation_id__annotation;
ALTER TABLE ONLY public.annotation DROP CONSTRAINT fk__annotation__document_id__document;
DROP INDEX public.subs_uri_idx_subscriptions;
DROP INDEX public.ix__user__userid;
DROP INDEX public.ix__group_readable_by;
DROP INDEX public.ix__group_name;
DROP INDEX public.ix__flag_user_id;
DROP INDEX public.ix__featurecohort_name;
DROP INDEX public.ix__document_uri_uri_normalized;
DROP INDEX public.ix__document_uri_updated;
DROP INDEX public.ix__document_uri_document_id;
DROP INDEX public.ix__document_meta_updated;
DROP INDEX public.ix__document_meta_document_id;
DROP INDEX public.ix__annotation_userid;
DROP INDEX public.ix__annotation_updated;
DROP INDEX public.ix__annotation_thread_root;
DROP INDEX public.ix__annotation_tags;
DROP INDEX public.ix__annotation_groupid;
ALTER TABLE ONLY public.user_group DROP CONSTRAINT uq__user_group__user_id;
ALTER TABLE ONLY public."user" DROP CONSTRAINT uq__user__email;
ALTER TABLE ONLY public.token DROP CONSTRAINT uq__token__value;
ALTER TABLE ONLY public.token DROP CONSTRAINT uq__token__refresh_token;
ALTER TABLE ONLY public."group" DROP CONSTRAINT uq__group__pubid;
ALTER TABLE ONLY public.flag DROP CONSTRAINT uq__flag__annotation_id;
ALTER TABLE ONLY public.featurecohort_user DROP CONSTRAINT uq__featurecohort_user__cohort_id;
ALTER TABLE ONLY public.featurecohort_feature DROP CONSTRAINT uq__featurecohort_feature__cohort_id;
ALTER TABLE ONLY public.feature DROP CONSTRAINT uq__feature__name;
ALTER TABLE ONLY public.document_uri DROP CONSTRAINT uq__document_uri__claimant_normalized;
ALTER TABLE ONLY public.document_meta DROP CONSTRAINT uq__document_meta__claimant_normalized;
ALTER TABLE ONLY public.blocklist DROP CONSTRAINT uq__blocklist__uri;
ALTER TABLE ONLY public.authzcode DROP CONSTRAINT uq__authzcode__code;
ALTER TABLE ONLY public.activation DROP CONSTRAINT uq__activation__code;
ALTER TABLE ONLY public.user_group DROP CONSTRAINT pk__user_group;
ALTER TABLE ONLY public."user" DROP CONSTRAINT pk__user;
ALTER TABLE ONLY public.token DROP CONSTRAINT pk__token;
ALTER TABLE ONLY public.subscriptions DROP CONSTRAINT pk__subscriptions;
ALTER TABLE ONLY public.setting DROP CONSTRAINT pk__setting;
ALTER TABLE ONLY public."group" DROP CONSTRAINT pk__group;
ALTER TABLE ONLY public.flag DROP CONSTRAINT pk__flag;
ALTER TABLE ONLY public.featurecohort_user DROP CONSTRAINT pk__featurecohort_user;
ALTER TABLE ONLY public.featurecohort_feature DROP CONSTRAINT pk__featurecohort_feature;
ALTER TABLE ONLY public.featurecohort DROP CONSTRAINT pk__featurecohort;
ALTER TABLE ONLY public.feature DROP CONSTRAINT pk__feature;
ALTER TABLE ONLY public.document_uri DROP CONSTRAINT pk__document_uri;
ALTER TABLE ONLY public.document_meta DROP CONSTRAINT pk__document_meta;
ALTER TABLE ONLY public.document DROP CONSTRAINT pk__document;
ALTER TABLE ONLY public.blocklist DROP CONSTRAINT pk__blocklist;
ALTER TABLE ONLY public.authzcode DROP CONSTRAINT pk__authzcode;
ALTER TABLE ONLY public.authticket DROP CONSTRAINT pk__authticket;
ALTER TABLE ONLY public.authclient DROP CONSTRAINT pk__authclient;
ALTER TABLE ONLY public.annotation_moderation DROP CONSTRAINT pk__annotation_moderation;
ALTER TABLE ONLY public.annotation DROP CONSTRAINT pk__annotation;
ALTER TABLE ONLY public.activation DROP CONSTRAINT pk__activation;
ALTER TABLE public.user_group ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."user" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.token ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE public.featurecohort_user ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.featurecohort_feature ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.featurecohort ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.feature ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.document_uri ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.document_meta ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.document ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.blocklist ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.authzcode ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.annotation_moderation ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE public.featurecohort_user_id_seq;
DROP TABLE public.featurecohort_user;
DROP SEQUENCE public.featurecohort_id_seq;
DROP SEQUENCE public.featurecohort_feature_id_seq;
DROP TABLE public.featurecohort_feature;
DROP TABLE public.featurecohort;
DROP SEQUENCE public.feature_id_seq;
DROP TABLE public.feature;
DROP SEQUENCE public.document_uri_id_seq;
DROP TABLE public.document_uri;
DROP SEQUENCE public.document_meta_id_seq;
DROP TABLE public.document_meta;
DROP SEQUENCE public.document_id_seq;
DROP TABLE public.document;
DROP SEQUENCE public.blocklist_id_seq;
DROP TABLE public.blocklist;
DROP SEQUENCE public.authzcode_id_seq;
DROP TABLE public.authzcode;
DROP TABLE public.authticket;
DROP TABLE public.authclient;
DROP SEQUENCE public.annotation_moderation_id_seq;
DROP TABLE public.annotation_moderation;
DROP TABLE public.annotation;
DROP SEQUENCE public.activation_id_seq;
DROP TABLE public.activation;
DROP TYPE public.group_writeable_by;
DROP TYPE public.group_readable_by;
DROP TYPE public.group_joinable_by;
DROP TYPE public.authclient_response_type;
DROP TYPE public.authclient_grant_type;
